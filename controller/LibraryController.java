...
public class LibraryController {
    ...
    private final String username; // Tracks the current user

    public LibraryController(Library library, String username) {
    ...
    // --- UPDATED FILE I/O CALLS ---
    public void saveLibraryData() {
        FileHandler.saveLibrary(username, library.getAllEntries());
    }

    public void loadLibraryData() {
        List<MediaEntry> savedData = FileHandler.loadLibrary(username);
        if (savedData != null) {
    ...
    public boolean exportDashboardReport() {
        return FileHandler.exportSummaryReport(username, getSummary());
    }
